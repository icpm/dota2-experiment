...
def get_dataloader(batch_size, test_batch_size, fold=0, image_dir='../frames'):
    ...
    training_data_loader = DataLoader(dataset=train_set, batch_size=batch_size, shuffle=True, num_workers=1)
    testing_data_loader = DataLoader(dataset=test_set, batch_size=test_batch_size, shuffle=False, num_workers=1)
